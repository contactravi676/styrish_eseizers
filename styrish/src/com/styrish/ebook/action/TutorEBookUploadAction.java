package com.styrish.ebook.action;
...
import com.styrish.ebook.dao.EBookDaoImpl;


public class TutorEBookUploadAction extends ActionSupport implements ServletContextAware {
	...
	public String execute() {
		try {
			...
			String documentAdditionPath=eBookDaoImpl.getEbookAdditionPath(subcourseId);
